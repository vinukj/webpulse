...
async function loadCanvas(){
    // Set up canvas for video viewport
    canvas = document.getElementById('output');
    canvas.width = video.videoWidthSom/1.10
    canvas.height = video.videoHeight/1.10
...
async function pollctx(){
    ...
    if (times.length > timesLen){
        ...
        heartrateIndicator.textContent = "HR: " + Math.round(heartrate) + " BPM"
